...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Problem 9: Factors of a Number</title>
...
<div class="question-panel">
  <h2>🔢 Problem 20: Factors of a Number</h2>

  <div>
    <p><strong>📝 Description:</strong></p>
    <p>Write a program to find and print all the factors of a given number.</p>
  </div>
  ...
  <div>
    ...
    <p>All factors of the number (space-separated)</p>
  </div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim() === "1 2 4 8") {
