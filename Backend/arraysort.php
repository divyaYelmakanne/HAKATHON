...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Check Sorted Array</title>
...
<div class="question-panel">
  <h2 style="color: #228b22;">📊 Problem 5: Check if Array is Sorted</h2>

  <p><strong>📝 Description:</strong> Write a function to check whether an array is sorted in non-decreasing order.</p>

  <p><strong>📥 Input:</strong> A space-separated list of integers</p>

  <p><strong>📤 Output:</strong> Print <code>Sorted</code> if the array is sorted, otherwise print <code>Not Sorted</code></p>
...
Input: 5 3 4
Output: Not Sorted</pre>

  <p><strong>🧪 Test Case:</strong></p>
  <pre id="test-cases">1 2 3 4 5</pre>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      const output = (data.stdout || "").trim().toLowerCase();
      if (output === "sorted") {
