...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Unique Element in Array</title>
...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 19: Find Unique Element in Array</h2>

  <div style="margin-bottom: 20px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Given an array where every element appears twice except for one unique element, find the unique element.</p>
  </div>
  ...
  <div style="margin-bottom: 15px;">
    ...
    <p style="margin-left: 15px; color: #444;">Return the unique element.</p>
  </div>
...
Output: 4</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px; color: #000;">4 1 2 1 2</pre>
  </div>
</div>
