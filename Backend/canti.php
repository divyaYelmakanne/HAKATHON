...
<html lang="en">
<head>
    <title>Dashboard - NextGenEd</title>
    <style>
...
<div class="header">
    ...
    <div class="header-title">NextGenEd</div> <!-- Centered title -->
...
document.querySelector("a").addEventListener("click", function (e) {
    ...
    function shareOnWhatsApp(platform) {
        let randomTexts = [
            " Iam a Stundet From NextGenEd, I am eagerly waiting for your guidance on " + platform + ".",
            " Iam a Stundet From NextGenEd, Looking forward to an amazing session on " + platform + ".",
            " Iam a Stundet From NextGenEd, Excited to connect with you on " + platform + " for guidance."
        ];
...
<div class="review-container">
        <div class="review-box">
            ...
            <p class="review-text">NextGenEd revolutionizes learning by providing personalized quizzes, enhancing student engagement, and improving knowledge retention.</p>
        </div>
        ...
        <div class="review-box">
            ...
            <p class="review-text">With AI-powered question generation and a seamless UI, NextGenEd makes exam preparation efficient and user-friendly.</p>
        </div>
        ...
        <div class="review-box">
            ...
            <div class="review-company">Assistant Professor</div>
            <p class="review-text">NextGenEd ensures accuracy in evaluation by offering real-time performance insights, correct answers, and personalized feedback</p>
        </div>
        ...
        <div class="review-box">
            ...
            <div class="review-company">Assistant Professor</div>
            <p class="review-text">By simulating real exam conditions, NextGenEd boosts confidence and readiness, making learning stress-free and effective.</p>
        </div>
    </div>
    </div>
    <div id="bxs">
    ...
    <div class="review-container-students">
        ...
        <div class="review-box-students">
            ...
            <p class="review-text-students">NextGenEd's lecture notes simplify complex topics, making studying more organized and efficient.</p>
        </div>
        <div class="review-box-students">
            ...
            <p class="review-text-students">I love how NextGenEd generates topic-based quizzes instantly, it saves time and improves my accuracy!</p>
        </div>
        </div>
    </div>
    <div id="bxse">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    ...
    <div class="career-section">
        ...
        <div class="career-content">
            <h2 class="career-heading">NextGenEd offers career guidance to help students explore various career paths, develop essential skills, and prepare for future job opportunities.</h2>
            <br>
...
<footer style="background-color:#838996; color: white; padding: 20px; text-align: center; color: white; padding: 40px 20px;">
    <div style="max-width: 1200px; margin: auto; display: flex; flex-wrap: wrap; justify-content: space-between;">
        ...
        <div style="flex: 1; min-width: 250px; margin-bottom: 20px;">
            <img src="assets/images/logo.jpeg" alt="NextGenEd" style="width: 180px; border-radius:10px"><br><br>

            <p style="margin-top: 10px;">© Copyright 2025 <b>NextGenEd</b> - All Rights Reserved</p><br>
            <hr><br>
