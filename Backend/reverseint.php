...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Reverse an Integer</title>
...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔁 Problem 17: Reverse an Integer</h2>

  <div style="margin-bottom: 20px;">
    <p><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Write a program to reverse a given integer number. The reversed number should not include any leading zeros.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong style="color: #333;">📥 Input:</strong></p>
    <p style="margin-left: 15px; color: #444;">A positive integer <code>n</code></p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong style="color: #333;">📤 Output:</strong></p>
    <p style="margin-left: 15px; color: #444;">The reversed integer</p>
  </div>

  <div style="margin-bottom: 20px;">
    <p><strong style="color: #333;">📌 Example:</strong></p>
...
Output: 4321</pre>
  ...
  <div>
    <p><strong style="color: #333;">🧪 Test Cases:</strong></p>
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px; color: #000;">12340</pre>
  </div>
</div>
...
<div class="editor-panel">
  ...
  <div id="editor"><h4 style="color:#FFFAFA;text-align:center; margin-top:25px; padding-top:7px;margin-left:300px; border-radius:8px; background-color:#355e3b; height:30px; width: 350px;" >Let’s Reverse This Challenge!</h4><br><br></div>
