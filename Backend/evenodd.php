...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 1: Even or Odd</h2>

  <div style="margin-bottom: 20px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Write a function that checks whether a given integer is even or odd.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📥 Input:</strong></p>
    <p style="margin-left: 15px; color: #444;">An integer <code style="background: #eee; padding: 2px 4px; border-radius: 4px;">n</code></p>
  </div>

  <div style="margin-bottom: 15px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📤 Output:</strong></p>
    <p style="margin-left: 15px; color: #444;">Print <code>Even</code> if the number is even, else print <code>Odd</code></p>
  </div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim().toLowerCase() === "odd") {
