...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 12: Find Duplicate Elements in Array</h2>

  <div style="margin-bottom: 20px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Given an array of integers, find all elements that appear more than once.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📥 Input:</strong></p>
    <p style="margin-left: 15px; color: #444;">An array of integers</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p style="margin: 5px 0;"><strong style="color: #333;">📤 Output:</strong></p>
    <p style="margin-left: 15px; color: #444;">Return all duplicate elements in any order. If no duplicates, return -1.</p>
  </div>
...
Output: 2 3</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px; color: #000;">1 2 3 2 3 4</pre>
  </div>
</div>
...
<div class="editor-panel">
  ...
  <div id="editor">
    <h4 style="color:#FFFAFA;text-align:center; margin-top:25px; padding-top:7px;margin-left:300px; border-radius:8px; background-color:#355e3b; height:30px; width: 350px;">
      Lets Dive into New Challenges!
    </h4>
    <br><br>
  </div>
  ...
  function runCode() {
    ...
    .then(data => {
      if (data.stdout) {
        ...
        outputDiv.innerHTML = `<pre style="color:red;">Error: ${data.message || "Something went wrong"}</pre>`;
      }
    })
    .catch(err => {
