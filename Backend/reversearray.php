...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Reverse an Array</title>
...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔁 Problem 16: Reverse an Array</h2>

  <div style="margin-bottom: 20px;">
    <p><strong>📝 Description:</strong></p>
    <p style="margin-left: 15px;">Write a program to reverse an array of integers.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong>📥 Input:</strong></p>
    <p style="margin-left: 15px;">An integer array in space-separated format.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong>📤 Output:</strong></p>
    <p style="margin-left: 15px;">The reversed array, space-separated.</p>
  </div>
...
Output: 5 4 3 2 1</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px;">10 20 30 40</pre>
  </div>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim() === input.trim().split(' ').reverse().join(' ')) {
