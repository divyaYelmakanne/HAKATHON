...
<div class="question-panel">
  <h2 style="color: #228b22;">🔍 Problem 11: Two Sum</h2>
  <p><strong>📝 Description:</strong><br>Given an array of integers and a target value, return the indices of the two numbers such that they add up to the target.</p>
  <p><strong>📥 Input:</strong><br>An array of integers and a target integer value.</p>
  <p><strong>📤 Output:</strong><br>Indices of the two elements (space-separated).</p>
  <p><strong>📌 Example:</strong></p>
  <pre style="background: #f2f2f2; padding: 10px; border-radius: 8px;">
Input:
5
2 7 11 15 3
9
