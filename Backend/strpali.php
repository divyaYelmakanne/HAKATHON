...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 6: String Palindrome</h2>

  <div style="margin-bottom: 20px;">
    <p><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Write a program that checks whether a given string is a palindrome or not.</p>
  </div>
  ...
  <div style="margin-bottom: 15px;">
    ...
    <p style="margin-left: 15px; color: #444;">Print <code>Palindrome</code> if the string is a palindrome, otherwise print <code>Not Palindrome</code>.</p>
  </div>
...
Output: Palindrome</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="margin-left: 15px;">madam</pre>
  </div>
</div>
