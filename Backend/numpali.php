...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔢 Problem 15: Number Palindrome</h2>

  <div style="margin-bottom: 20px;">
    <p><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Write a program that checks whether a given integer is a palindrome or not.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong style="color: #333;">📥 Input:</strong></p>
    <p style="margin-left: 15px; color: #444;">An integer <code>n</code></p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong style="color: #333;">📤 Output:</strong></p>
    <p style="margin-left: 15px; color: #444;">Print <code>Palindrome</code> if the number is a palindrome, otherwise print <code>Not Palindrome</code>.</p>
  </div>
...
Output: Palindrome</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px; color: #000;">121</pre>
  </div>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim().toLowerCase() === "palindrome") {
