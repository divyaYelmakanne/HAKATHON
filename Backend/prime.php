...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 2: Prime Number Checker</h2>

  <div style="margin-bottom: 20px;">
    <p><strong style="color: #333;">📝 Description:</strong></p>
    <p style="margin-left: 15px; color: #444;">Write a function to check whether a number is prime or not.</p>
  </div>
  ...
  <div style="margin-bottom: 15px;">
    ...
    <p style="margin-left: 15px; color: #444;">Print <code>Prime</code> if the number is a prime number, else print <code>Not Prime</code></p>
  </div>
...
Output: Prime</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px; color: #000;">7</pre>
  </div>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim().toLowerCase() === "prime") {
