...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Find Element in Array</title>
...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 8: Find Element in Array</h2>

  <div style="margin-bottom: 20px;">
    <p><strong>📝 Description:</strong></p>
    <p style="margin-left: 15px;">Write a program to check whether a specific number exists in the array or not.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong>📥 Input:</strong></p>
    <p style="margin-left: 15px;">First line: space-separated integers (the array)</br>Second line: the number to search.</p>
  </div>

  <div style="margin-bottom: 15px;">
    <p><strong>📤 Output:</strong></p>
    <p style="margin-left: 15px;">Print "Found" if the number exists, otherwise "Not Found".</p>
  </div>

  <div style="margin-bottom: 20px;">
    <p><strong>📌 Example:</strong></p>
    <pre style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px;">
Input:
1 2 3 4 5
3
...
Found</pre>
  ...
  <div>
    ...
    <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px;">10 20 30 40 50
25</pre>
  </div>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    const expected = arr.includes(target) ? "Found" : "Not Found";
    ...
    .then(res => res.json())
    .then(data => {
      const actual = data.stdout ? data.stdout.trim() : "";
      if (actual === expected) {
