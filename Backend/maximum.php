...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Problem 14: Maximum of Array</title>
...
<div class="question-panel">
  <h2>📊 Problem 7: Maximum of Array</h2>

  <div>
    <p><strong>📝 Description:</strong></p>
    <p>Write a program that finds the maximum element in a given array of integers.</p>
  </div>

  <div>
    <p><strong>📥 Input:</strong></p>
    <p>An array of integers (space-separated)</p>
  </div>

  <div>
    <p><strong>📤 Output:</strong></p>
    <p>The maximum integer from the array</p>
  </div>
...
Output: 9
  ...
  <div>
    ...
    <pre id="test-cases">3 7 2 9 4</pre>
  </div>
</div>
