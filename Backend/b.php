...
<head>
  <meta charset="UTF-8">
  <title>StudyBot - NextGenEd</title>
  <style>
    body {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["prompt"])) {
    ...
    $data = [
        ...
        "messages" => [
            [
                "role" => "system",
                "content" => "You are a NextGenEd AI. Based on the user's input topic, generate a mock test in clean HTML format with the following exact format and rules:
