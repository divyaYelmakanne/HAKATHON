...
<head>
  <meta charset="UTF-8" />
  <title>CodeCraft - Frequency of Element</title>
...
<div class="question-panel">
  <h2 style="color: #228b22; font-size: 24px; margin-bottom: 15px;">🔍 Problem 10: Frequency of Element</h2>

  <p><strong>📝 Description:</strong></p>
  <p style="margin-left: 15px;">Write a program to count the number of occurrences of a specific element <code>x</code> in an array.</p>

  <p><strong>📥 Input:</strong></p>
  <p style="margin-left: 15px;">Two lines. First line: array of integers. Second line: element x to search for.</p>

  <p><strong>📤 Output:</strong></p>
  <p style="margin-left: 15px;">Print the count of x in the array.</p>
...
3</pre>
  ...
  <pre id="test-cases" style="background: #f2f2f2; padding: 10px; border-radius: 8px; margin-left: 15px;">1 2 3 2 4 2
2</pre>
</div>
...
<script>
  ...
  function submitCode() {
    ...
    .then(res => res.json())
    .then(data => {
      if (data.stdout && data.stdout.trim() === "3") {
